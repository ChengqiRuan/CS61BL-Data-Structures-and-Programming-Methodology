...
public class NGramMap {
    ...
    public NGramMap(String wordsFilename, String countsFilename) {
        ...
        try (Scanner wordScan = new Scanner(wordFile)) {
            while (wordScan.hasNext()) {
                ...
                if (wordCountData.containsKey(word)) {
                    t = wordCountData.get(word).plus(t);
                }
        ...
        for (String word : wordCountData.keySet()) {
            TimeSeries t = wordCountData.get(word);
            wordWeightData.put(word, t.dividedBy(totalWordsPerYear));
        }
    }
