...
<<<<<<< HEAD
    public void testCountHistory() throws FileNotFoundException {
        NGramMap ngm = new NGramMap("./data/ngrams/word_history_size3.csv", "./data/ngrams/year_history.csv");
=======
    public void testCountHistory() {
        NGramMap ngm = new NGramMap(WORD_HISTORY_SIZE3_FILE, YEAR_HISTORY_FILE);
>>>>>>> b0355254538429e1bad1605badc94949c47583d9
    ...
    @Test
    public void testOnShortFile() throws FileNotFoundException {
        // creates an NGramMap from a large dataset
<<<<<<< HEAD
        NGramMap ngm = new NGramMap("./data/ngrams/word_history_size4.csv", "./data/ngrams/year_history.csv");
=======
...
>>>>>>> b0355254538429e1bad1605badc94949c47583d9
    ...
    public void testOnLargeFile() throws FileNotFoundException {
        // creates an NGramMap from a large dataset
<<<<<<< HEAD
        NGramMap ngm = new NGramMap("./data/ngrams/word_history_size14377.csv", "./data/ngrams/year_history.csv");
=======
